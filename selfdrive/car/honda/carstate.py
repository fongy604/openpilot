...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, cp_body):
    ...
    if self.CP.enableGasInterceptor:
      ...
      self.user_gas_pressed = self.user_gas > 10  # this works because interceptor read < 0 when pedal position is 0. Once calibrated, this will change
    ...
    if self.CP.carFingerprint in (CAR.PILOT, CAR.CIVIC, CAR.PILOT_2019, CAR.RIDGELINE):
      if ret.brake > 0.05:
